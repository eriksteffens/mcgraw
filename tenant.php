...
<div id="main" class="container">
	<div class="row">
		<div class="col s12">
			<h3 class="center-align list-title"> Tenant Forms </h3>
		</div>
	</div>
	
		<div id="asset-list" class="col s12">
		<div class="row menu-row">
		<div class="newObject col s5"><a href="#modal1" class="addbutton waves-effect waves-light btn valign">New Tenant</a></div>
