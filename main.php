...
<div id="main" class="container">
	<div class="row">
		<div class="col s12">
			<h3 class="center-align list-title"> Asset Forms </h3>
		</div>
	</div>
	
		<div id="asset-list" class="col s12">
		<div class="row menu-row">
		<div class="newObject col s5"><a href="#modal1" class="addbutton waves-effect waves-light btn valign">New Asset</a></div>
				      				...
				      				<?php foreach ($fields[$tab] as $field){ 
				      					...
				      					if(!in_array($tab, $completedTabs)){
											...
											<?php 
				      						...
				      						<a class="btn downbtn" id="<?php echo friendly($field->name) . "_go"; ?>" href="<?php if($field->related = "Tenants"){echo "tenant.php#item-[id]";}; ?>" ><i class="material-icons">search</i></a>
				      						
				          					<select name="<?php echo $field->name; ?>" id="<?php echo friendly($field->name); ?>" class="border-field validate mcfile">
				          					<?php }else{ ?>
				          						<select name="<?php echo $field->name; ?>" id="<?php echo friendly($field->name); ?>" class="border-field validate">
